...
documents](https://datatracker.ietf.org/wg/curdle/documents/) and [mailing
list discussion](https://mailarchive.ietf.org/arch/browse/curdle/). If you're
...
([info](https://www.ietf.org/mailman/listinfo/curdle)). This will ensure that
